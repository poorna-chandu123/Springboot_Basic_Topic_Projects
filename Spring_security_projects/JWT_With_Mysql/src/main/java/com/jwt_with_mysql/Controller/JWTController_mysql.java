package com.jwt_with_mysql.Controller;


import com.jwt_with_mysql.Security.JwtUtils_mysql;
import com.jwt_with_mysql.SecurityLogin.LoginRequest_mysql;
import com.jwt_with_mysql.SecurityLogin.LoginResponces_mysql;
...
public class JWTController_mysql {
    ...
    public ResponseEntity<?> authenticateUser(@RequestBody LoginRequest_mysql loginRequestMysql) {
        ...
        String jwt = jwtUtilsMysql.generateTokenfromUsername(userDetails);
